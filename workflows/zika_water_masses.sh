...
cmip_tfiles=(`ls ${cmip_dir}/${cmip_exp}/${ripf}/Omon/thetao/${grid}/${version}/*.nc`)
cmip_sfiles=(`ls ${cmip_dir}/${cmip_exp}/${ripf}/Omon/so/${grid}/${version}/*.nc`)
scenario_tfiles=(`ls ${scenario_dir}/${scenario_exp}/${ripf}/Omon/thetao/${grid}/${version}/*.nc`)

# Basin file

basin_dir=${r87_cmip_dir}/${fx_exp}/${ripf}/Ofx/basin/${grid}/${version}
mkdir -p ${basin_dir}
...
area_file=${cmip_dir}/${fx_exp}/${ripf}/Ofx/areacello/${grid}/${version}/areacello_Ofx_${model}_${fx_exp}_${ripf}_${grid}.nc
volume_dir=${r87_cmip_dir}/${fx_exp}/${ripf}/Ofx/volcello/${grid}/${version}
mkdir -p ${volume_dir}
...
mkdir -p ${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/water-mass/${grid}/${version}
cmip_wm_command="bash ${script_dir}/calc_water_mass_components.sh ${volume_file} ${basin_file} ${cmip_tfiles[@]}"
echo ${cmip_wm_command}
#${cmip_wm_command}

mkdir -p ${r87_scenario_dir}/${scenario_exp}/${ripf}/Omon/water-mass/${grid}/${version}
...
r87_tdir=${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/thetao/${grid}/${version}
mkdir -p ${r87_tdir}
...
r87_sdir=${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/so/${grid}/${version}
mkdir -p ${r87_sdir}
...
r87_vdist_dir=${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/volo/${grid}/${version}
