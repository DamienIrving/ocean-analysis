...
cmip_tfiles=(`ls ${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/thetao/${grid}/${cmip_version}/thetao_Omon_${model}_${cmip_exp}_${ripf}_${grid}_??????-??????.nc`)
cmip_sfiles=(`ls ${r87_cmip_dir}/${cmip_exp}/${ripf}/Omon/so/${grid}/${cmip_version}/so_Omon_${model}_${cmip_exp}_${ripf}_${grid}_??????-??????.nc`)
...
#scenario_tfiles=(`ls ${r87_scenario_dir}/${scenario_exp}/${ripf}/Omon/thetao/${grid}/${scenario_version}/thetao_Omon_${model}_${scenario_exp}_${ripf}_${grid}_??????-??????.nc`)
#scenario_sfiles=(`ls ${r87_scenario_dir}/${scenario_exp}/${ripf}/Omon/so/${grid}/${scenario_version}/so_Omon_${model}_${scenario_exp}_${ripf}_${grid}_??????-??????.nc`)
...
areacello_file=${r87_cmip_dir}/${fx_exp}/${ripf}/Ofx/areacello/${grid}/${fx_version}/areacello_Ofx_${model}_${fx_exp}_${ripf}_${grid}.nc
