...
PR_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Amon/pr/${GRID_SURFACE}/${ATMOS_CNTRL_VERSION}/pr*.nc))
...
FLUX_YR_DIR_EXP=${MY_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${EXP_RUN}/Ayr/${FLUX_VAR}/${GRID_SURFACE}/${ATMOS_EXP_VERSION}
...
AREA_YR_DIR_EXP=${MY_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${EXP_RUN}/Ayr/areacella/${GRID_SURFACE}/${ATMOS_EXP_VERSION}
...
AREA_PE_REGIONS_FILE_EXP=${AREA_YR_DIR_EXP}/areacella-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
AREA_PE_REGIONS_CUMSUM_FILE_EXP=${AREA_YR_DIR_EXP}/areacella-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_REGIONS_FILE_EXP=${PE_YR_DIR_EXP}/pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
PE_REGIONS_CUMSUM_FILE_EXP=${PE_YR_DIR_EXP}/pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_PER_M2_REGIONS_FILE_EXP=${PE_YR_DIR_EXP}/pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
${PE_PER_M2_REGIONS_FILE_EXP}: ${PE_FILE_EXP} ${FX_BASIN_FILE}
	mkdir -p ${PE_YR_DIR_EXP}
	${PYTHON} ${DATA_SCRIPT_DIR}/calc_pe_spatial_totals.py $< $(word 2,$^) mean $@ --annual

PE_PER_M2_REGIONS_CUMSUM_FILE_EXP=${PE_YR_DIR_EXP}/pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PR_PE_REGIONS_FILE_EXP=${PR_YR_DIR_EXP}/pr-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
PR_PE_REGIONS_CUMSUM_FILE_EXP=${PR_YR_DIR_EXP}/pr-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
${PR_PE_REGIONS_CUMSUM_FILE_EXP}: ${PR_PE_REGIONS_FILE_EXP}
	${PYTHON} ${DATA_SCRIPT_DIR}/calc_cumsum.py $< precipitation_flux $@

PR_PE_REGIONS_CUMSUM_FILE_CNTRL=${PR_YR_DIR_CNTRL}/pr-pe-region-sum_Ayr_${MODEL}_piControl_${CNTRL_RUN}_${GRID_SURFACE}_${CNTRL_TIME}.nc
...
PR_PER_M2_PE_REGIONS_FILE_EXP=${PR_YR_DIR_EXP}/pr-pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
PR_PER_M2_PE_REGIONS_CUMSUM_FILE_EXP=${PR_YR_DIR_EXP}/pr-pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
EVAP_PE_REGIONS_FILE_EXP=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
EVAP_PE_REGIONS_CUMSUM_FILE_EXP=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
EVAP_PER_M2_PE_REGIONS_FILE_EXP=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}.nc
...
EVAP_PER_M2_PE_REGIONS_CUMSUM_FILE_EXP=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-mean_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
FLUX_PE_REGIONS_FILE_EXP=${FLUX_YR_DIR_EXP}/${FLUX_VAR}-pe-region-sum_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_REGIONS_CUMSUM_ANOMALY=${PE_YR_DIR_EXP}/pe-region-sum-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_PER_M2_REGIONS_CUMSUM_ANOMALY=${PE_YR_DIR_EXP}/pe-region-mean-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PR_PE_REGIONS_CUMSUM_ANOMALY=${PR_YR_DIR_EXP}/pr-pe-region-sum-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PR_PER_M2_PE_REGIONS_CUMSUM_ANOMALY=${PR_YR_DIR_EXP}/pr-pe-region-mean-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
EVAP_PE_REGIONS_CUMSUM_ANOMALY=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-sum-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
EVAP_PER_M2_PE_REGIONS_CUMSUM_ANOMALY=${EVAP_YR_DIR_EXP}/evspsbl-pe-region-mean-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
FLUX_PE_REGIONS_CUMSUM_ANOMALY=${FLUX_YR_DIR_EXP}/${FLUX_VAR}-pe-region-sum-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
AREA_PE_REGIONS_CUMSUM_ANOMALY=${AREA_YR_DIR_EXP}/areacella-pe-region-sum-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_CUMSUM_HIST=${PE_YR_DIR_EXP}/pe_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
...
PE_CUMSUM_ANOMALY=${PE_YR_DIR_EXP}/pe-anomaly_Ayr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_${GRID_SURFACE}_${EXP_TIME}-cumsum.nc
