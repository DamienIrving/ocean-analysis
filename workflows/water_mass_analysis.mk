...
SURFACE_WATER_MASS_DIR_EXP=${MY_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${EXP_RUN}/Omon/surface-water-mass/${GRID}/${EXP_VERSION}
...
sf-raw-cntrl : ${SF_BINNED_FILE_EXP}
