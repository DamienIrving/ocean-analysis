...
SALINITY_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/so/${GRID_OCEAN}/${CNTRL_VERSION}/so*.nc)) 
TEMPERATURE_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/thetao/${GRID_OCEAN}/${CNTRL_VERSION}/thetao*.nc))
SURFACE_TBIN_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/${SURFACE_TBIN_VAR}/${GRID_SURFACE}/${CNTRL_VERSION}/${SURFACE_TBIN_VAR}*.nc))
SURFACE_SBIN_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/${SURFACE_SBIN_VAR}/${GRID_SURFACE}/${CNTRL_VERSION}/${SURFACE_SBIN_VAR}*.nc))
SF_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/${SF_VAR}/${GRID_SURFACE}/${CNTRL_VERSION}/${SF_VAR}*.nc))
