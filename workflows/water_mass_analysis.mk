...
BASIN_FILE_SURFACE=${MY_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/historical/${BASIN_RUN}/Ofx/basin/${GRID_SURFACE}/${BASIN_VERSION}/basin_Ofx_${MODEL}_historical_${BASIN_RUN}_${GRID_SURFACE}.nc
...
AREACELLO_FILE=${AREACELLO_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/${FX_EXP}/${FX_RUN}/Ofx/areacello/${GRID_SURFACE}/${OFX_VERSION_AREACELLO}/areacello_Ofx_${MODEL}_${FX_EXP}_${FX_RUN}_${GRID_SURFACE}${AREACELLO_FILE_END}
