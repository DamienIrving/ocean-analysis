...
TOS_FILES_HIST := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/historical/${HIST_RUN}/Omon/${TOS_VAR}/${GRID}/${HIST_VERSION}/${TOS_VAR}*.nc))
...
TOS_FILES_CNTRL := $(sort $(wildcard ${CMIP6_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Omon/${TOS_VAR}/${GRID}/${CNTRL_VERSION}/${TOS_VAR}*.nc))
...
SF_BINNED_FILE_HIST=${SF_BINNED_DIR_HIST}/${SF_VAR}-${TOS_VAR}-binned_Omon_${MODEL}_historical_${HIST_RUN}_${GRID}_${HIST_TIME}.nc
...
SF_BINNED_FILE_CNTRL=${SF_BINNED_DIR_CNTRL}/${SF_VAR}-${TOS_VAR}-binned_Omon_${MODEL}_piControl_${CNTRL_RUN}_${GRID}_${CNTRL_TIME}.nc
...
SF_BINNED_CUMSUM_FILE_HIST=${SF_BINNED_DIR_HIST}/${SF_VAR}-${TOS_VAR}-binned_Omon_${MODEL}_historical_${HIST_RUN}_${GRID}_${HIST_TIME}-cumsum.nc
${SF_BINNED_CUMSUM_FILE_HIST} : ${SF_BINNED_FILE_HIST}
	${PYTHON} ${DATA_SCRIPT_DIR}/calc_cumsum.py $< ${SF_NAME} $@ --flux_to_mag

SF_BINNED_CUMSUM_FILE_CNTRL=${SF_BINNED_DIR_CNTRL}/${SF_VAR}-${TOS_VAR}-binned_Omon_${MODEL}_piControl_${CNTRL_RUN}_${GRID}_${CNTRL_TIME}-cumsum.nc
${SF_BINNED_CUMSUM_FILE_CNTRL} : ${SF_BINNED_FILE_CNTRL}
	${PYTHON} ${DATA_SCRIPT_DIR}/calc_cumsum.py $< ${SF_NAME} $@ --flux_to_mag

## remove drift / calculate anomaly

SF_BINNED_CUMSUM_COEFFICIENT_FILE=${SF_BINNED_DIR_CNTRL}/${SF_VAR}-${TOS_VAR}-binned-coefficients_Omon_${MODEL}_piControl_${CNTRL_RUN}_${GRID}_${CNTRL_TIME}-cumsum.nc
...
SF_ANOMALY_BINNED_CUMSUM_FILE=${SF_BINNED_DIR_HIST}/${SF_VAR}-anomaly-${TOS_VAR}-binned_Omon_${MODEL}_historical_${HIST_RUN}_${GRID}_${HIST_TIME}-cumsum.nc
...
SF_ANOMALY_BINNED_CUMSUM_PLOT=/g/data/r87/dbi599/temp/${SF_VAR}-anomaly-${TOS_VAR}-binned_Omon_${MODEL}_historical_${HIST_RUN}_${GRID}_${HIST_TIME}-cumsum_bin34.png
