...
CONTROL_FILES=$(wildcard ${ORIG_CONTROL_DIR}/${MODEL}/piControl/mon/ocean/${CONTROL_RUN}/${VAR}/latest/${VAR}_Omon_${MODEL}_piControl_${CONTROL_RUN}_*.nc)
CONTROL_DIR=${MY_CMIP5_DIR}/${MODEL}/piControl/yr/ocean/${CONTROL_RUN}/${VAR}/latest
DRIFT_COEFFICIENTS=${CONTROL_DIR}/${VAR}-coefficients_Oyr_${MODEL}_piControl_${CONTROL_RUN}_all.nc

VARIABLE_FILES=$(wildcard ${ORIG_VARIABLE_DIR}/${MODEL}/${EXPERIMENT}/mon/ocean/${RUN}/${VAR}/latest/${VAR}_Omon_${MODEL}_${EXPERIMENT}_${RUN}_*.nc)

DEDRIFTED_VARIABLE_DIR=${MY_CMIP5_DIR}/${MODEL}/${EXPERIMENT}/yr/ocean/${RUN}/${VAR}/latest/dedrifted
DEDRIFTED_VARIABLE_FILES = $(patsubst ${ORIG_VARIABLE_DIR}/${MODEL}/${EXPERIMENT}/mon/ocean/${RUN}/${VAR}/latest/${VAR}_Omon_%.nc, ${DEDRIFTED_VARIABLE_DIR}/${VAR}_Oyr_%.nc, ${VARIABLE_FILES})

VARIABLE_MAPS_DIR=${MY_CMIP5_DIR}/${MODEL}/${EXPERIMENT}/yr/ocean/${RUN}/${VAR}-maps/latest
...
DEPTH_FILE=${ORIG_DEPTH_DIR}/${MODEL}/${EXPERIMENT}/fx/ocean/${FX_RUN}/deptho/latest/deptho_fx_${MODEL}_${EXPERIMENT}_${FX_RUN}.nc
