...
SURFACE_VAR_REMAPPED_DIR_EXP=${MY_DATA_DIR}/${PROJECT}/${MIP}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${EXP_RUN}/Oyr/${SURFACE_OUTVAR}/${GRID_SURFACE}/${EXP_VERSION}
SURFACE_VAR_REMAPPED_FILE_EXP=${SURFACE_VAR_REMAPPED_DIR_EXP}/${SURFACE_OUTVAR}_Oyr_${MODEL}_${EXPERIMENT}_${EXP_RUN}_x360y180_${EXP_TIME}.nc
...
SURFACE_VAR_REMAPPED_DIR_CNTRL=${MY_DATA_DIR}/${PROJECT}/CMIP/${INSTITUTION}/${MODEL}/piControl/${CNTRL_RUN}/Oyr/${SURFACE_OUTVAR}/${GRID_SURFACE}/${CNTRL_VERSION}
SURFACE_VAR_REMAPPED_FILE_CNTRL=${SURFACE_VAR_REMAPPED_DIR_CNTRL}/${SURFACE_OUTVAR}_Oyr_${MODEL}_piControl_${CNTRL_RUN}_x360y180_${CNTRL_TIME}.nc
${SURFACE_VAR_REMAPPED_FILE_CNTRL} :
	mkdir -p ${SURFACE_VAR_REMAPPED_DIR_CNTRL}
	${PYTHON} ${DATA_SCRIPT_DIR}/regrid.py ${SURFACE_VAR_FILES_CNTRL} ${SURFACE_VAR_STD_NAME} $@ --annual --lats -89.5 89.5 1 --lons 0.5 359.5 1 --surface
