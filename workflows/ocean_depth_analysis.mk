...
SALINITY_MEAN_FILE_CNTRL=${SALINITY_MEAN_DIR_CNTRL}/so-${BASIN}-zonal-mean_Oyr_${MODEL}_piControl_${CNTRL_RUN}_${GRID}_${CNTRL_TIME}.nc
...
SALINITY_MEAN_DEDRIFTED_FILE=${SALINITY_MEAN_DIR_EXP}/so-${BASIN}-zonal-mean-dedrifted_Oyr_${MODEL}_historical_${HIST_RUN}_${GRID_OCEAN}_${EXP_TIME}.nc
...
SALINITY_MEAN_DEDRIFTED_REMAPPED_FILE=${SALINITY_MEAN_DIR_EXP}/so-${BASIN}-zonal-mean-dedrifted_Oyr_${MODEL}_historical_${HIST_RUN}_taimoor-grid_${EXP_TIME}.nc
...
${SURFACE_SALINITY_REMAPPED_FILE} : 
	${PYTHON} ${DATA_SCRIPT_DIR}/regrid.py ${SURFACE_SALINITY_FILES_EXP} ${SURFACE_SBIN_VAR} $@ --annual --lats -89.5 89.5 1 --lons 0.5 395.5 1 #TODO: --surface (crop data if need be)
