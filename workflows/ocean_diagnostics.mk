...
INDIR=/g/data/fs38/publications/CMIP6/${PROJECT}/CSIRO-ARCCSS/ACCESS-CM2
MYDIR=/g/data/e14/dbi599/CMIP6/${PROJECT}/CSIRO-ARCCSS/ACCESS-CM2
OUTDIR=/g/data/e14/dbi599/CMIP6/${PROJECT}/CSIRO-ARCCSS/ACCESS-CM2

THETAO_FILES_HIST := $(sort $(wildcard ${INDIR}/${EXP}/${RUN}/Omon/thetao/gn/${VERSION_HIST}/*.nc))
SO_FILES_HIST := $(sort $(wildcard ${INDIR}/${EXP}/${RUN}/Omon/so/gn/${VERSION_HIST}/*.nc))
TOS_FILES_HIST := $(sort $(wildcard ${INDIR}/${EXP}/${RUN}/Omon/tos/gn/${VERSION_HIST}/*.nc))
SOS_FILES_HIST := $(sort $(wildcard ${INDIR}/${EXP}/${RUN}/Omon/sos/gn/${VERSION_HIST}/*.nc))
...
SO_FILES_CNTRL := $(sort $(wildcard $/g/data/fs38/publications/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/piControl/r1i1p1f1/Omon/thetao/gn/piControl/r1i1p1f1/Omon/so/gn/${VERSION_CNTRL}/*.nc))
TOS_FILES_CNTRL := $(sort $(wildcard /g/data/fs38/publications/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/piControl/r1i1p1f1/Omon/thetao/gn/piControl/r1i1p1f1/Omon/tos/gn/${VERSION_CNTRL}/*.nc))
SOS_FILES_CNTRL := $(sort $(wildcard /g/data/fs38/publications/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/piControl/r1i1p1f1/Omon/thetao/gn/piControl/r1i1p1f1/Omon/sos/gn/${VERSION_CNTRL}/*.nc))

FRAZIL_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/frazil-3d/gn/${VERSION_HIST}/frazil-3d_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
MIXDOWNSLOPE_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/mixdownslope-temp/gn/${VERSION_HIST}/mixdownslope-temp_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
NEUTRAL_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/neutral-diffusion-temp/gn/${VERSION_HIST}/neutral-diffusion-temp_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
SFCHP_FILE_HIST=${MYDIR}/${EXP}/${RUN}/Omon/sfc-hflux-pme/gn/${VERSION_HIST}/sfc-hflux-pme_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_185001-201412.nc
SWHEAT_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/sw-heat/gn/${VERSION_HIST}/sw-heat_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
ETA_FILE_HIST=${MYDIR}/${EXP}/${RUN}/Omon/temp-eta-smooth/gn/${VERSION_HIST}/temp-eta-smooth_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_185001-201412.nc
KPP_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-nonlocal-KPP/gn/${VERSION_HIST}/temp-nonlocal-KPP_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
RIVER_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-rivermix/gn/${VERSION_HIST}/temp-rivermix_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
SIGMA_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-sigma-diff/gn/${VERSION_HIST}/temp-sigma-diff_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
TENDENCY_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-tendency/gn/${VERSION_HIST}/temp-tendency_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
CBT_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-diff-cbt/gn/${VERSION_HIST}/temp-vdiffuse-diff-cbt_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
K33_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-k33/gn/${VERSION_HIST}/temp-vdiffuse-k33_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))
SBC_FILES_HIST := $(sort $(wildcard ${MYDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-sbc/gn/${VERSION_HIST}/temp-vdiffuse-sbc_Omon_ACCESS-CM2_${EXP}_${RUN}_gn_*.nc))

FRAZIL_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/frazil-3d/gn/${VERSION_CNTRL}/frazil-3d_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
MIXDOWNSLOPE_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/mixdownslope-temp/gn/${VERSION_CNTRL}/mixdownslope-temp_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
NEUTRAL_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/neutral-diffusion-temp/gn/${VERSION_CNTRL}/neutral-diffusion-temp_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
SFCHP_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/sfc-hflux-pme/gn/${VERSION_CNTRL}/sfc-hflux-pme_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
SWHEAT_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/sw-heat/gn/${VERSION_CNTRL}/sw-heat_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
ETA_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-eta-smooth/gn/${VERSION_CNTRL}/temp-eta-smooth_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
KPP_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-nonlocal-KPP/gn/${VERSION_CNTRL}/temp-nonlocal-KPP_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
RIVER_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-rivermix/gn/${VERSION_CNTRL}/temp-rivermix_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
SIGMA_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-sigma-diff/gn/${VERSION_CNTRL}/temp-sigma-diff_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
TENDENCY_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-tendency/gn/${VERSION_CNTRL}/temp-tendency_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
CBT_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-diff-cbt/gn/${VERSION_CNTRL}/temp-vdiffuse-diff-cbt_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
K33_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-k33/gn/${VERSION_CNTRL}/temp-vdiffuse-k33_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
SBC_FILES_CNTRL := $(sort $(wildcard ${MYDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-sbc/gn/${VERSION_CNTRL}/temp-vdiffuse-sbc_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_*.nc))
...
BASIN_FILE=/g/data/fs38/publications/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/historical/r1i1p1f1/Ofx/basin/gn/v20191108/basin_Ofx_ACCESS-CM2_historical_r1i1p1f1_gn.nc

# Primary variables

WFO_BINNED_HIST_FILE=${OUTDIR}/${EXP}/${RUN}/Omon/wfo/gn/${VERSION_HIST}/wfo-tos-sos-binned_Omon_ACCESS-CM2_${EXP}_r1i1p1f1_gn_${TIME_HIST}.nc
WFO_BINNED_CNTRL_FILE=${OUTDIR}/piControl/r1i1p1f1/Omon/wfo/gn/${VERSION_CNTRL}/wfo-tos-sos-binned_Omon_ACCESS-CM2_piControl_r1i1p1f1_gn_${TIME_CNTRL}.nc

FRAZIL_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/frazil-3d/gn/${VERSION_HIST}
...
FRAZIL_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/frazil-3d/gn/${VERSION_CNTRL}
...
MIXDOWNSLOPE_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/mixdownslope-temp/gn/${VERSION_HIST}
...
MIXDOWNSLOPE_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/mixdownslope-temp/gn/${VERSION_CNTRL}
...
NEUTRAL_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/neutral-diffusion-temp/gn/${VERSION_HIST}
...
NEUTRAL_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/neutral-diffusion-temp/gn/${VERSION_CNTRL}
...
SFCHP_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sfc-hflux-pme/gn/${VERSION_HIST}
...
SFCHP_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sfc-hflux-pme/gn/${VERSION_CNTRL}
...
SWHEAT_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sw-heat/gn/${VERSION_HIST}
...
SWHEAT_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sw-heat/gn/${VERSION_CNTRL}
...
ETA_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-eta-smooth/gn/${VERSION_HIST}
...
ETA_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-eta-smooth/gn/${VERSION_CNTRL}
...
KPP_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-nonlocal-KPP/gn/${VERSION_HIST}
...
KPP_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-nonlocal-KPP/gn/${VERSION_CNTRL}
...
RIVER_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-rivermix/gn/${VERSION_HIST}
...
RIVER_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-rivermix/gn/${VERSION_CNTRL}
...
SIGMA_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-sigma-diff/gn/${VERSION_HIST}
...
SIGMA_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-sigma-diff/gn/${VERSION_CNTRL}
...
TENDENCY_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-tendency/gn/${VERSION_HIST}
...
TENDENCY_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-tendency/gn/${VERSION_CNTRL}
...
CBT_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-diff-cbt/gn/${VERSION_HIST}
...
CBT_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-diff-cbt/gn/${VERSION_CNTRL}
...
K33_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-k33/gn/${VERSION_HIST}
...
K33_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-k33/gn/${VERSION_CNTRL}
...
SBC_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/temp-vdiffuse-sbc/gn/${VERSION_HIST}
...
SBC_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/temp-vdiffuse-sbc/gn/${VERSION_CNTRL}
...
VMIX_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/vmix/gn/${VERSION_HIST}
...
VMIX_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/vmix/gn/${VERSION_CNTRL}
...
SMIX_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/smix/gn/${VERSION_HIST}
...
SMIX_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/smix/gn/${VERSION_CNTRL}
...
SFCV_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sfcv/gn/${VERSION_HIST}
...
SFCV_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sfcv/gn/${VERSION_CNTRL}
...
SFCH_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sfch/gn/${VERSION_HIST}
...
SFCH_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sfch/gn/${VERSION_CNTRL}
...
SFC_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sfc/gn/${VERSION_HIST}
...
SFC_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sfc/gn/${VERSION_CNTRL}
...
RMIX_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/rmix/gn/${VERSION_HIST}
...
RMIX_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/rmix/gn/${VERSION_CNTRL}
...
MIX_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/mix/gn/${VERSION_HIST}
...
MIX_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/mix/gn/${VERSION_CNTRL}
...
SFCI_BINNED_HIST_DIR=${OUTDIR}/${EXP}/${RUN}/Omon/sfci/gn/${VERSION_HIST}
...
SFCI_BINNED_CNTRL_DIR=${OUTDIR}/piControl/r1i1p1f1/Omon/sfci/gn/${VERSION_CNTRL}
