...
#WFO_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${RUN}/Omon/wfo/${GRID}/${HIST_VERSION}/wfo*.nc))
#WFO_FILES_CNTRL := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/${RUN}/Omon/wfo/${GRID}/${CNTRL_VERSION}/wfo*.nc))
#SALINITY_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${RUN}/Omon/so/${GRID}/${HIST_VERSION}/so*.nc)) 
#SALINITY_FILES_CNTRL := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/${RUN}/Omon/so/${GRID}/${CNTRL_VERSION}/so*.nc)) 
#PR_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${RUN}/Amon/pr/${GRID}/${HIST_VERSION}/pr*.nc))
...
WFO_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/mon/ocean/Omon/${RUN}/files/wfo_20110518/wfo*.nc))
WFO_FILES_CNTRL := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/mon/ocean/Omon/${RUN}/${CNTRL_VERSION}/wfo/wfo*.nc))
SALINITY_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/mon/ocean/Omon/${RUN}/${HIST_VERSION}/so/so*.nc))
SALINITY_FILES_CNTRL := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/mon/ocean/Omon/${RUN}/${CNTRL_VERSION}/so/so*.nc))
#PR_FILES_HIST := $(sort $(wildcard ${NCI_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/mon/atmos/Amon/${RUN}/${HIST_VERSION}/pr/pr*.nc))
...
WFO_DIR_HIST=${MY_EXP_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${RUN}/Oyr/wfo/${GRID}/${HIST_VERSION}
WFO_ZONAL_SUM_FILE_HIST=${WFO_DIR_HIST}/wfo-zonal-sum_Oyr_${MODEL}_${EXPERIMENT}_${RUN}_${GRID}_${HIST_TIME}-cumsum.nc
...
WFO_DIR_CNTRL=${MY_EXP_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/${RUN}/Oyr/wfo/${GRID}/${CNTRL_VERSION}
...
WFO_ANOMALY_CUMSUM=${WFO_DIR_HIST}/wfo-zonal-sum-anomaly_Oyr_${MODEL}_${EXPERIMENT}_${RUN}_${GRID}_${HIST_TIME}-cumsum.nc
...
SO_DIR_HIST=${MY_EXP_DATA_DIR}/${INSTITUTION}/${MODEL}/${EXPERIMENT}/${RUN}/Oyr/so/${GRID}/${HIST_VERSION}
SO_VZM_HIST=${SO_DIR_HIST}/so-vertical-zonal-mean_Oyr_${MODEL}_${EXPERIMENT}_${RUN}_${GRID}_${HIST_TIME}.nc
...
SO_DIR_CNTRL=${MY_EXP_DATA_DIR}/${INSTITUTION}/${MODEL}/piControl/${RUN}/Oyr/so/${GRID}/${CNTRL_VERSION}
...
SO_VZM_HIST_DEDRIFTED=${SO_DIR_HIST}/so-vertical-zonal-mean-dedrifted_Oyr_${MODEL}_${EXPERIMENT}_${RUN}_${GRID}_${HIST_TIME}.nc
...
FINAL_PLOT=/g/data/r87/dbi599/temp/water-cycle-change_Oyr_${MODEL}_${EXPERIMENT}_${RUN}_${GRID}_${HIST_TIME}.png
