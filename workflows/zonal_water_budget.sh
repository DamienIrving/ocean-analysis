...
area_file=${ua6_dir}/${experiment}/fx/ocean/r0i0p0/areacello/latest/areacello_fx_${model}_historical_r0i0p0.nc
volume_file=${ua6_dir}/${experiment}/fx/ocean/r0i0p0/volcello/latest/volcello_fx_${model}_historical_r0i0p0.nc
ref_file=" "
# " " if already lat/lon
...
so_coefficient_command="${python} ${script_dir}/calc_drift_coefficients.py ${control_zonal_mean_file} sea_water_salinity ${so_coefficient_file} --remove_outliers missing"
