...
def plot_ensemble_lines(df, model_list, experiment):
    ...
    for plot_num, var_name in enumerate(var_list):
        ...
        ylabel = 'Accumulated P-E anomaly (kg)' if 'cumulative' in var_name else 'Change in P-E (%)'
...
def main(inargs):
    ...
    for infile in inargs.infiles:
        cube, anomaly_data, start = get_data(infile, time_constraint)
    ...
    plot_ensemble_lines(df, model_list, experiment)
