...
headers = ['trend, OHC',
           ...
           'regression coefficient, cumulative netTOA radiative flux vs cumulative heat flux into ocean (cubic dedrift, decadal mean)',
           ...
           'regression coefficient, cumulative heat flux into ocean vs thermal OHC anomaly (cubic dedrift, decadal mean)',
