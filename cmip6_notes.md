...
| CESM2 | Website, Reference, [ES-DOC](https://explore.es-doc.org/cmip6/models/ncar/cesm2) |  |  | 1. Bogus global `volcello` (after adding missing land mask) and `areacello` totals - use `gr` and calculate own `Ofx` variables. |
