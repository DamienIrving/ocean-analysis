...
| GISS-E2-1-H | [Website](https://data.giss.nasa.gov/modelE/cmip6/), Reference, ES-DOC | | | 1. The `v20190410/so_Omon_GISS-E2-1-H_piControl_r1i1p1f1_gr_322001-323912.nc` file is missing. <br> 2. For both `thetao` and `so` the `358001-358012` control file needs to be removed as it overlaps with the correct `358001-359912` file. |
