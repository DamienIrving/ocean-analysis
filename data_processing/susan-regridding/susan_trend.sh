...
dedrift_command="${python} ${script_dir}/remove_drift.py ${data_dir}/${variable}_Oyr_${model}_${experiment}_${rip}_??????-??????_susan-grid.nc sea_water_potential_temperature annual ${coef_file} ${data_dir}/dedrifted/ --branch_time 29200"
