...
def get_boundary_indexes(xintercept_indexes, lat_coord):
    ...
    for index in xintercept_indexes:
        ...
        if (lat < 5) and (lat > -25) and not sh_north_bound:
    ...
    for index in reversed(xintercept_indexes):
        ...
        if (lat > -5) and (lat < 25) and not nh_south_bound:
    ...
    assert (lat_coord[sh_north_bound] < 5) and (lat_coord[sh_north_bound] > -25)
    assert (lat_coord[nh_south_bound] > -5) and (lat_coord[nh_south_bound] < 25)
