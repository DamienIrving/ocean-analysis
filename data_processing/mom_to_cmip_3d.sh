...
if [ "${experiment}" == "historical" ] ; then
    ...
    date_range_list=(185001-185912 186001-186912 187001-187912 188001-188912 189001-189912 190001-190912 190001-190912 191001-191912 192001-192912 193001-193912 194001-194912 195001-195912 196001-196912 197001-197912 198001-198912 199001-199912 200001-200912 201001-201912 202001-202012)
    version=v20201120
    project=DAMIP
...
ref_dir=/g/data/fs38/publications/CMIP6/${project}/CSIRO-ARCCSS/ACCESS-CM2/${experiment}/${run}/Omon/thetao/gn/${version}
...
ref_file=${ref_dir}/thetao_Omon_ACCESS-CM2_${experiment}_${run}_gn_${date_range}.nc
...
command="${python} mom_to_cmip.py ${data_dir}/ocean_month.nc-${date_range:0:3}* ${data_var} ${ref_file} sea_water_potential_temperature ${out_dir}/${file_var}_Omon_ACCESS-CM2_${experiment}_${run}_gn_${date_range}.nc ${single}"
