#!/bin/bash
#
# Description: Run calc_temporal_aggregate.py over a bunch of files
#             
...
for infile in "${infiles[@]}"; do
    ...
    command="${python} ${script_dir}/calc_temporal_aggregate.py ${infile} sea_water_potential_temperature ${outfile} --annual"
